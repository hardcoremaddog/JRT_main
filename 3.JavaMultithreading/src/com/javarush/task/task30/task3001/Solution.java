...
public class Solution {
    ...
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        ...
        return new Number(expectedNumerationSystem, String.valueOf(new BigInteger(number.getDigit(), number.getNumerationSystem().getNumerationSystemIntValue()).toString(expectedNumerationSystem.getNumerationSystemIntValue())));
    }
}
